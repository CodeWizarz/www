(function() {
  ...
  */
  ...
  var wrapper = document.querySelector('.slpBlog');
  var container = wrapper.querySelector('.slpBlog__article');
  ...
  generateHeaderLinks(container)
    ...
    .catch(() =>
      console.warn(
        "generate-navigation-helpers-blog.js generateHeaderLinks/generateHeaderLinkScrollHelpers didn't initialize properly"
      )
    );
