...
We released it together with out blog post [What founders ask founders about getting into Y Combinator](/blog/2016/09/30/what-founders-ask-founders-about-getting-into-yc/)
...
{: .panel-heading}
<div class="panel-body">
We created GitLab together (</gitlab-ce/>) and now over 100.000 organizations are using it. We also created GitLab CI and GitLab CI Runner together </features/continuous-integration/>. This pair of programs allow organizations to distribute their code testing over a number of workers.
</div>
</div>
...
{: .panel-heading}
<div class="panel-body">
Currently we get users through word of mouth (amplified by twitter). During our time at YC we would like to grow our marketing, our [continuous integration product](/features/continuous-integration/) GitLab CI and our SaaS (GitLab.com). GitLab.com currently has only 15k monthly active users but we see a lot of possibilities to grow and differentiate it.
</div>
</div>
