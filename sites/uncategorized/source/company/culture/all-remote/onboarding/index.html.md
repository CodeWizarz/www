...
Managers play a crucial role in onboarding. Their work starts when setting up the job position during the recruiting process and interviewing candidates, and continues from the first day to the first year of a team member's employment. However, navigating onboarding can be challenging to both experienced and [new managers](handbook/people-group/learning-and-development/manager-development/). 

To help new hires have a positive onboarding experience that will set them up for long-term success, consider including the following in a manager’s team member's onboarding plan:

- Understand what each person in their team needs and know what tools are available to [guide new hires during onboarding](#how-to-manage-onboarding-new-hires-remotely) and their tenure at GitLab.
- [Welcome the new hire into the team](#social-requirements-for-all-remote-onboarding), help [build new relationships](/handbook/leadership/building-trust/), and cultivate a culture of [psychological safety](/handbook/leadership/emotional-intelligence/psychological-safety/) within the organization.
- Provide a clear path for the new hire to understand what success looks like in their role. Every role at GitLab is tied to performance metrics that will help managers assess progress and provide [constructive feedback](/company/culture/all-remote/effective-communication/#feedback-is-a-gift) during onboarding.
- Ensure the new hire feels empowered to participate in defining and adding goals to their onboarding plan, such as investing in developing a particular skill. This will help set the tone for their [learning and development](/handbook/people-group/learning-and-development/#team-member-resources) plans. 
- [Ask powerful questions and practice active listening](/handbook/leadership/coaching/) to help put aside assumptions, solutions or advice to truly hear the other person. Consider asking new team members the following questions:
    - How do you prefer to receive feedback (in-person, in-writing)?
    - How much social interaction is important to you?
    - How do you like to be recognized for work?
    - What are your biggest motivators and why?
