...
description: "Learn more about GitLab Release 7.5.2 for GitLab Community Edition (CE) and Enterprise Edition (EE)"
canonical_path: "/releases/2014/12/03/gitlab-7-5-2-and-gitlab-ci-5-2-1-released/"
date: 2014-12-03
categories: releases
...
Omnibus-gitlab packages for GitLab 7.5.2 and GitLab CI 5.2.1 are [now available](/install/).
