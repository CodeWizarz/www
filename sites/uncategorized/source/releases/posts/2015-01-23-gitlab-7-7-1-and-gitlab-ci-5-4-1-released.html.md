...
description: "Learn more about GitLab Release 7.7.1 and Gitlab CI 5.4.1 for GitLab Community Edition (CE) and Enterprise Edition (EE)"
canonical_path: "/releases/2015/01/23/gitlab-7-7-1-and-gitlab-ci-5-4-1-released/"
date: 2015-01-23
categories: releases
...
Omnibus-gitlab packages for GitLab 7.7.1 and GitLab CI 5.4.1 are [now available](/install/).
