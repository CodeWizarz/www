...
description: "Learn more about GitLab Release 7.10 for GitLab Community Edition (CE) and Enterprise Edition (EE)"
canonical_path: "/releases/2015/04/22/gitlab-7-10-released/"
date: 2015-04-22
categories: releases
...
This is the first release since GitLab graduated from [Y Combinator](/blog/2015/03/04/gitlab-is-part-of-the-y-combinator-family/).
...
If you already have an existing Omnibus package installed please see our [instructions for restoring the bin links](/releases/2015/04/23/gitlab-7-dot-10-dot-0-omnibus-patch-release/#rpm-upgrade-issues) after running the command below.
