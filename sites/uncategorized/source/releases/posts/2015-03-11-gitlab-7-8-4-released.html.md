...
description: "Learn more about GitLab Release 7.8.4 for GitLab Community Edition (CE) and Enterprise Edition (EE)"
canonical_path: "/releases/2015/03/11/gitlab-7-8-4-released/"
date: 2015-03-11
categories: releases
...
Omnibus-gitlab packages for GitLab 7.8.4 are [now available](/install/).
