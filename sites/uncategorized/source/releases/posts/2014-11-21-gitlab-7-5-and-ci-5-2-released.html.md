...
description: "Learn more about GitLab Release 7.5 for GitLab Community Edition (CE) and Enterprise Edition (EE)"
canonical_path: "/releases/2014/11/21/gitlab-7-5-and-ci-5-2-released/"
date: 2014-11-21
categories: releases
...
This month's Most Valuable Person ([MVP](/community/mvp/)) is Martijn van Bemmel.
...
the [MVP Badge](/community/mvp/), the [Golden Gear medal](https://gitlab.com/gitlab-com/www-gitlab-com/merge_requests/318#note_296648) and the [various](/community/) [graphics](/features/) on our site.
...
GitLab CI is [now bundled with GitLab](/blog/2014/11/06/gitlab-omnibus-packages-now-include-gitlab-ci/)!
If you prefer to install GitLab CI manually, please see the [documentation](https://docs.gitlab.com/ee/ci/quick_start/).
